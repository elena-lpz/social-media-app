...
export default function LandingPage() {
  return (
    <section className="mx-5 md:mx-6 lg:mx-16 text-left">
      <div className="flex flex-col lg:flex-row justify-center items-center h-[80dvh] gap-8 lg:gap-40">
        <div>
          <div className="w-[90dvw] lg:w-[auto] flex flex-col gap-8">
          ...
          <div className="flex flex-col">
            ...
            <Link
              href={`/sign-up`}
              className="md:w-fit text-sm md:text-lg bg-white rounded-4xl text-background flex items-center gap-3 font-semibold ps-5 pe-3 py-2 hover:bg-neutral-700 hover:text-white"
            >
              Join today
